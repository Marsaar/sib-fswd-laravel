    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#!">BangunPC</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="#!">Home</a></li>
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="{{ route('ecommerce.dashboard') }}">Dashboard</a></li>
                        <li class="nav-item"><a class="nav-link" href="#!">About</a></li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Shop</a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="#!">Monitors</a></li>
                                <li><a class="dropdown-item" href="#!">GPUs</a></li>
                                <li><a class="dropdown-item" href="#!">RAMs</a></li>
                                <li><a class="dropdown-item" href="#!">PC</a></li>
                                <li><a class="dropdown-item" href="#!">Storages</a></li>
                            </ul>
                        </li>
                    </ul>
                    <form class="d-flex">
                        ...
                        <a href="{{ route('login') }}" class="btn btn-outline-dark ms-2" role="button" >
                            <i class="bi-cart-fill me-1"></i>
                            Login
                        </a>
                    </form>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <form action="{{ route('ecommerce.landing') }}" method="GET">
                    @csrf
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        <!-- Product name-->
                                        <a href="{{ route('ecommerce.product.show', ['id' => $product->id]) }}" style="text-decoration: none" class="text-dark">
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Marsa Aushaf Rafi Website Project</p></div>
        </footer>
        <!-- Bootstrap core JS-->
