...
@section('content')
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form action="{{ route('ecommerce.product.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <a href="{{ route('ecommerce.product.index') }}" class="btn btn-secondary">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
