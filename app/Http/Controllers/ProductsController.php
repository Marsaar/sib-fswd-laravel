...
class ProductsController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect()->route('ecommerce.product.index')->with('success', 'Product created successfully.');
    }
    ...
    public function show($id)
        {
            ...
            if ($product) {
                return view('ecommerce.product.show', compact('product', 'related'));
            } else {
                abort(404);
            }
    ...
    public function edit($id)
    {
        ...
        return view('ecommerce.product.edit', compact('product', 'brands', 'categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('ecommerce.product.index')->with('success', 'Product updated successfully.');
    }
